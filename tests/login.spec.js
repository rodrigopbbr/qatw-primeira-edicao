...
// test('Deve acessar a conta do usuário válido via DB', async ({ page }) => {
//     const loginPage = new LoginPage(page)
...
test('Deve acessar a conta do usuário válido via Redis', async ({ page }) => {
    const loginPage = new LoginPage(page)
    const dashPage = new DashPage(page)
    ...
    // Checkpoint -- Espera exatamente até 3 segundos. 
